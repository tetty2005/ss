function task2 (envelope1, envelope2) {
    if (typeof envelope1 !== 'object' || typeof envelope2 !== 'object') {
        ...
        return (envelope1.a < envelope2.c && envelope1.b < envelope2.c ||   // первый конверт меньше?
            envelope1.a < envelope2.d && envelope1.b < envelope2.d) ? 1 :   // а если повернуть?
            (envelope2.c < envelope1.a && envelope2.d < envelope1.b  ||     // или второй меньше?
            envelope2.d < envelope1.a && envelope2.c < envelope1.b) ? 2 : 0;// а если повернуть?
    }
}
