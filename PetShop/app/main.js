...
function upload () {
    ...
    view.petShop.addPets(new Cat('white', 650, 'SnowWhite', true));
    view.petShop.addPets(new Dog('black', 300, 'Gimmy'));
    view.petShop.addPets(new Cat('black', 550, 'Bagira', true));
    ...
    view.petShop.addPets(new Cat('red', 100, 'Reddy', false));
